            ...
            <div className="glass-panel" style={{ padding: '30px', width: '100%', maxWidth: '400px' }}>
                ...
                {step === 'auth' ? (
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        ...
                        <button className="glass-button" type="submit" disabled={loading} style={{ background: 'linear-gradient(135deg, #8b5cf6, #06b6d4)', justifyContent: 'center', marginTop: '10px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', textAlign: 'center' }}>
                        ...
                        <button
                            ...
                            style={{ background: 'linear-gradient(135deg, #8b5cf6, #06b6d4)', justifyContent: 'center' }}
                        >
                            Back to Login
                        </button>
                    </div>
